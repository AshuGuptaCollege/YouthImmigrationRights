...
let allStories = ["Cyrus's Story", "Alex's Story", "Patrick's Story", "Sara's Story", "Molly's Story", "Samuel's Story", ];

//static global variable to hold all story competency codes
//it's in order from first story to last in allStories
let storyCompetencies = ["Detentions", "ICE In Public", "Undocumented at School", "Undocumented at Home", "Undocumented in Public", "Mixed Status at Household"];
...
let storyQuestionDescriptions = [
  ...
  ["Are you required to speak to law enforcement always?", "Should you lie to law enforcement?"],
...
//it's in order from first story to last in allStories
let storyDescriptions = ["A story about detentions, knowing your rights during these proceedings, and how to react to them.", "A story about how to react to ICE/law enforcement when encountering law enforcement in public.", "A story about meeting law enforcement at school.", "A story about meeting law enforcement at home.", "A story about meeting law enforcement in public.", "A story about talking to ICE when with mixed immigration status family members."];